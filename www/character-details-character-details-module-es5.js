...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["character-details-character-details-module"], {
  ...
  /***/
  function node_modulesIonicStorageFesm2015IonicStorageJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var localforage_cordovasqlitedriver__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! localforage-cordovasqlitedriver */
    "./node_modules/localforage-cordovasqlitedriver/dist/localforage-cordovasqlitedriver.js");
    /* harmony import */


    var localforage_cordovasqlitedriver__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(localforage_cordovasqlitedriver__WEBPACK_IMPORTED_MODULE_2__);
    /**
    ...
    var Storage = /*#__PURE__*/function () {
      ...
      function Storage(config) {
        ...
        this._dbPromise = new Promise(function (resolve, reject) {
          ...
          Object(localforage__WEBPACK_IMPORTED_MODULE_1__["defineDriver"])(localforage_cordovasqlitedriver__WEBPACK_IMPORTED_MODULE_2__).then(function () {
    ...
    var
    /** @type {?} */
    StorageConfigToken = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('STORAGE_CONFIG_TOKEN');
    /**
     * @hidden
     * @param {?} storageConfig
     * @return {?}
    ...
    var IonicStorageModule = /*#__PURE__*/function () {
  ...
  /***/
  function node_modulesLocalforageCordovasqlitedriverDistLocalforageCordovasqlitedriverJs(module, exports, __webpack_require__) {
  ...
  function srcAppPagesCharacterDetailsCharacterDetailsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CharacterDetailsPageRoutingModule = function CharacterDetailsPageRoutingModule() {
      _classCallCheck2(this, CharacterDetailsPageRoutingModule);
    };
  ...
  function srcAppPagesCharacterDetailsCharacterDetailsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CharacterDetailsPageModule = function CharacterDetailsPageModule() {
      _classCallCheck2(this, CharacterDetailsPageModule);
    };
  ...
  function srcAppPagesCharacterDetailsCharacterDetailsPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "ion-content {\n  background: url('breakingbad.jpg') no-repeat;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesCharacterDetailsCharacterDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CharacterDetailsPage = /*#__PURE__*/function () {
      function CharacterDetailsPage(activatedRoute, api, http, favouriteService) {
        _classCallCheck2(this, CharacterDetailsPage);
      ...
      _createClass(CharacterDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.api.getCharacter(this.characterId).subscribe(function (res) {
            _this2.character = res[0];
            console.log(JSON.stringify(_this2.character.character_id)); //Json to get the character info by ID
          });
          this.favouriteService.isFavourite(this.characterId).then(function (isFav) {
            _this2.isFavourite = isFav;
          });
        }
      }, {
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FavouriteService = /*#__PURE__*/function () {
      function FavouriteService(storage) {
        _classCallCheck2(this, FavouriteService);
        ...
        value: function favouriteEpisode(episodeId) {
          ...
          return this.getAllFavouriteEpisodes().then(function (result) {
            if (result) {
              ...
              return _this5.storage.set(STORAGE_KEY, [episodeId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteEpisode(episodeId) {
          ...
          return this.getAllFavouriteEpisodes().then(function (result) {
            if (result) {
              ...
              return _this6.storage.set(STORAGE_KEY, result);
            }
          });
        ...
        value: function favouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              return _this7.storage.set(STORAGE_KEY1, result);
            } else {
              return _this7.storage.set(STORAGE_KEY1, [characterId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this8.storage.set(STORAGE_KEY, result);
            }
          });
        }
      }]);
